...
const CircleSVG = /* @__PURE__ */ React__namespace.createElement(
  "svg",
  {
    "aria-hidden": "true",
...
const FlapSVG = /* @__PURE__ */ React__namespace.createElement(
  "svg",
  {
    "aria-hidden": "true",
...
const ScallopSVG = /* @__PURE__ */ React__namespace.createElement(
  "svg",
  {
    "aria-hidden": "true",
    className: "gds-sticker-background",
...
const Sticker = (props) => {
  ...
  return /* @__PURE__ */ React__namespace.createElement(
    "div",
    {
      className: clsx_m.clsx("gds-sticker", `gds-sticker-${size}`, `gds-sticker-${variant}`, className),
      ...rest
    },
...
const StickerDiscount = (props) => {
  ...
  return /* @__PURE__ */ React__namespace.createElement("div", { className: "gds-sticker-discount" }, /* @__PURE__ */ React__namespace.createElement(ScreenReaderOnly.ScreenReaderOnly, null, " ", `${discount} percent off a Grammarly Pro Plan`), /* @__PURE__ */ React__namespace.createElement("div", { "aria-hidden": "true" }, /* @__PURE__ */ React__namespace.createElement(Flex.Flex, { align: "center", justify: "center", gap: 1 }, /* @__PURE__ */ React__namespace.createElement("p", { className: "gds-sticker-discount-text" }, discount), /* @__PURE__ */ React__namespace.createElement(Flex.Flex, { direction: "column" }, /* @__PURE__ */ React__namespace.createElement("p", { className: "gds-sticker-percent-text" }, "%"), /* @__PURE__ */ React__namespace.createElement("p", { className: "gds-sticker-off-text" }, "Off"))), /* @__PURE__ */ React__namespace.createElement("p", { className: "gds-sticker-plan-text" }, "Grammarly Pro")));
};
const StickerCompound = compound.makeCompoundComponent(Sticker, "Sticker", {
  Discount: StickerDiscount
});
exports.Sticker = StickerCompound;
